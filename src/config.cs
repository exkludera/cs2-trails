...
public class TrailsConfig : BasePluginConfig
{
    ...
    {
        { "1", new Dictionary<string, string> { { "name", "Red Trail" }, { "color", "255 0 0 255" } } },
        { "2", new Dictionary<string, string> { { "name", "Green Trail" }, { "color", "0 255 0 255" } } },
        { "3", new Dictionary<string, string> { { "name", "Blue Trail" }, { "color", "0 0 255 255" } } },
        { "4", new Dictionary<string, string> { { "name", "Random Trail" }, { "color", "" } } }
    };
}